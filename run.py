...
class MyTrainer(Trainer):
    def my_train(self, last_checkpoint, model_name_or_path, output_dir, logger):
    ...
    def my_evaluate(self, logger, task_name, eval_dataset, datasets, output_dir):
    ...
    def my_predict(
        self, logger, task_name, test_dataset, datasets, output_dir, label_list
    ):
        logger.info("*** Test ***")
